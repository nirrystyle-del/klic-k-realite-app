(() => {
  ...
  function renderForecast() {
    ...
    setText(monthText, monthly.intro || `Číslo měsíce ${forecast.monthEnergy}`);
    setText(monthPositive, monthly.positive || "Bude doplněno podle výkladů.");
    setText(monthNegative, monthly.negative || "Bude doplněno podle výkladů.");
    setText(monthFinance, monthly.finance || "Bude doplněno podle výkladů.");
    setText(monthRelationships, monthly.relationships || "Bude doplněno podle výkladů.");
    setText(monthHealth, monthly.health || "Bude doplněno podle výkladů.");
