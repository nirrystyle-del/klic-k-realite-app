(() => {
  ...
  function renderForecast() {
    if (!todayNumber || !monthNumber) return;
    ...
    if (!profile) {
      ...
      todayText.textContent = "Nejdříve vyplňte profil.";
      todayRecommendations.innerHTML = "<li>Bude doplněno podle výkladů.</li>";
      todayFinance.textContent = "Bude doplněno podle výkladů.";
      todayRelationships.textContent = "Bude doplněno podle výkladů.";
      todayHealth.textContent = "Bude doplněno podle výkladů.";

      monthNumber.textContent = "?";
      monthText.textContent = "Nejdříve vyplňte profil.";
      monthTask.textContent = "Bude doplněno podle výkladů.";
      return;
    }
  ...
  init().catch((error) => {
    ...
    const fallbackProfile = readEmergencyProfile();
